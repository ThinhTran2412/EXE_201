    ...
    <>
      ...
      <AnimatePresence>
        {!isLoaded && (
          ...
          >
            <span className="font-sans font-extrabold text-2xl md:text-4xl tracking-[0.2em] text-white mb-8 select-none">
              PICKIC
            </span>
      ...
      >
        <a href="/" className="flex items-center gap-3">
          <span className="font-anton text-lg md:text-xl tracking-[0.1em] text-[#fff7e1] select-none">
            PICKIC
          </span>
        </a>
      ...
      <main className="relative z-10 pointer-events-none w-full min-h-screen">
        <section className="w-[90%] mx-auto h-screen flex flex-col py-8 md:py-12 lg:py-16 pb-12 justify-between">
          ...
          <div className="flex-1 w-full pointer-events-auto flex flex-col md:grid md:grid-cols-12 md:grid-rows-[1fr_auto] gap-y-12 md:gap-y-0 md:gap-x-8 items-stretch justify-center">
            <div className="md:row-start-2 md:col-start-1 md:col-span-7 flex items-end">
              <Reveal delay={0.2}>
                <h1 className="font-anton text-[clamp(1.5rem,3vw,2.75rem)] leading-[1.05] tracking-wide text-[#fff7e1] max-w-[900px]">
                  Pickic
                  <br />
        ...
        <section className="w-[90%] max-w-[1100px] mx-auto pointer-events-auto py-28 md:py-40 border-t border-[#fff7e1]/[0.06]">
          <div className="text-center mb-24">
            <Reveal delay={0.1}>
              ...
              <h2 className="font-anton text-2xl md:text-4xl text-[#fff7e1] tracking-wide">
                Hai mảnh ghép hoàn hảo tại Pickic
              </h2>
            </Reveal>
          </div>
        ...
        <section className="w-[90%] max-w-[1100px] mx-auto pointer-events-auto py-28 md:py-40 border-t border-[#fff7e1]/[0.06]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-12">
            ...
            <Reveal delay={0.4} className="flex flex-col items-center md:items-start text-center md:text-left">
              <span className="font-anton text-5xl md:text-6xl text-violet-400 mb-4">03</span>
        ...
        <section className="w-[90%] max-w-[1100px] mx-auto py-28 md:py-40 border-t border-[#fff7e1]/[0.06] pointer-events-auto">
          <div className="w-full mx-auto">
            <Reveal delay={0.1}>
              <p className="mt-0 text-[10px] font-mono tracking-[0.2em] text-[#ff4200] uppercase mb-3">
                Tính Năng
              </p>
        ...
        <section ref={screen3Ref} className="w-[90%] max-w-[1100px] mx-auto pb-28 pointer-events-auto">
          <div
            style={{
          ...
          >
            ...
            >
              <div className="flex flex-col gap-4">
                <span className="font-anton text-base tracking-[0.1em] text-[#fff7e1]/90 select-none">
                  PICKIC
                </span>
